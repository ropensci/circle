...
```r
circe::enable_repo()
✔ Successfully enabled repo 'ropenscilabs/circle' on Circle CI.
```
...
Alternatively you can borrow the config that is being used [in this repo](https://github.com/ropenscilabs/circle/blob/main/.circleci/config.yml) - which was also created via {tic}.
