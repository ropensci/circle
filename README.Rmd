...
[![AppVeyor build status](https://img.shields.io/appveyor/ci/ropenscilabs/circle?label=Windows&logo=appveyor&style=flat-square)](https://ci.appveyor.com/project/ropenscilabs/circle)
[![Codecov test coverage](https://codecov.io/gh/ropenscilabs/circle/branch/master/graph/badge.svg)](https://codecov.io/gh/ropenscilabs/circle?branch=master)
