...
2.  An active repository on Circle CI with access rights

Alternatively changes can be pushed to GitHub and being tested by the CI
runner. The CI runner operates on the `ropensci/circle` repo with access
to the respective secrets during the run.

### Code of Conduct

Please note that the circle project is released with a [Contributor Code
...
- you have a question, an use case, or otherwise not a bug or feature
  request for the software itself.
